...
-define(BIN_CONFIG_VALID_MULTICAST, <<"{ \"port\": 6666, \"multicast\": { \"ip\": \"224.0.0.251\", \"ttl\": 4, \"local_iface_address\": \"0.0.0.0\" }, \"rack_name\": \"dev_rack1\", \"racks\": { \"dev_rack1\": [\"", ?SEED_IP/binary ,"\"] } , \"symmetric_key\": \"v3JElaRswYgxOt4b\" }">>).
...
-define(BIN_CONFIG_INVALID_MULTICAST1, <<"{ \"port\": 6666, \"multicast\": { \"ttl\": 4, \"local_iface_address\": \"0.0.0.0\" }, \"rack_name\": \"dev_rack1\", \"racks\": { \"dev_rack1\": [\"", ?SEED_IP/binary ,"\"] } , \"symmetric_key\": \"v3JElaRswYgxOt4b\" }">>).
